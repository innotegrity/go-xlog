module go.innotegrity.dev/xlog
...
require (
	...
	go.innotegrity.dev/secretmgr v0.1.0
	go.innotegrity.dev/types v0.5.0
	go.innotegrity.dev/xerrors v0.3.4
...
replace go.innotegrity.dev/secretmgr => ../go-secretmgr
